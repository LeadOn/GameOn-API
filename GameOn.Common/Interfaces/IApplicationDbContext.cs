...
namespace GameOn.Common.Interfaces
{
    ...
    public interface IApplicationDbContext
    {
        ...
        /// </summary>
        public DbSet<LoLGameParticipantStat> LeagueOfLegendsGameParticipantStats { get; set; }

        /// <summary>
        /// Gets or sets LoL Queues.
        /// </summary>
        public DbSet<LoLQueue> LeagueOfLegendsQueues { get; set; }

        /// <summary>
        /// Gets or sets LoL Game Timeline Events.
        /// </summary>
        public DbSet<LoLGameTimelineEvent> LeagueOfLegendsGameTimelineEvents { get; set; }
