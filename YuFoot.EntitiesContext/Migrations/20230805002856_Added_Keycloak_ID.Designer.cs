...
namespace YuFoot.EntitiesContext.Migrations
{
    ...
    [Migration("20230805002856_Added_Keycloak_ID")]
    partial class Added_Keycloak_ID
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YuFoot.Entities.GamePlayed", b =>
                {
                    ...
                    b.Property<DateTime>("PlayedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 8, 5, 2, 28, 56, 180, DateTimeKind.Local).AddTicks(7890))
            ...
            modelBuilder.Entity("YuFoot.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2023, 8, 5, 2, 28, 56, 180, DateTimeKind.Local).AddTicks(9513))
