...
namespace GameOn.Persistence.Migrations
{
    ...
    [Migration("20241228165800_Fixed_issue_with_mandatory_key_on_LoL_Game_Participants")]
    partial class Fixed_issue_with_mandatory_key_on_LoL_Game_Participants
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameOn.Domain.Changelog", b =>
                {
                    ...
                    b.Property<DateTime>("PublicationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 28, 17, 57, 59, 979, DateTimeKind.Local).AddTicks(40))
            ...
            modelBuilder.Entity("GameOn.Domain.FifaGamePlayed", b =>
                {
                    ...
                    b.Property<DateTime>("PlayedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 17, 57, 59, 975, DateTimeKind.Local).AddTicks(4027))
            ...
            modelBuilder.Entity("GameOn.Domain.LeagueOfLegendsRankHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 17, 57, 59, 979, DateTimeKind.Local).AddTicks(1088))
            ...
            modelBuilder.Entity("GameOn.Domain.Player", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 16, 57, 59, 974, DateTimeKind.Utc).AddTicks(6497))
                        .HasColumnName("created_on");
            ...
            modelBuilder.Entity("GameOn.Domain.Tournament", b =>
                {
                    ...
                    b.Property<DateTime>("PlannedFrom")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 16, 57, 59, 974, DateTimeKind.Utc).AddTicks(7796))
                        .HasColumnName("planned_from");

                    b.Property<DateTime>("PlannedTo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 12, 29, 16, 57, 59, 974, DateTimeKind.Utc).AddTicks(8002))
            ...
            modelBuilder.Entity("GameOn.Domain.TournamentPlayer", b =>
                {
                    ...
                    b.Property<DateTime>("JoinedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 12, 28, 16, 57, 59, 975, DateTimeKind.Utc).AddTicks(216))
