...
namespace GameOn.Persistence.Migrations
{
    ...
    [Migration("20260923102421_Added_LoLGameParticipantRankChange")]
    partial class Added_LoLGameParticipantRankChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameOn.Domain.Changelog", b =>
                {
                    ...
                    b.Property<DateTime>("PublicationDate")
                        ...
                        .HasDefaultValue(new DateTime(1999, 5, 21, 0, 0, 0, 0, DateTimeKind.Utc))
            ...
            modelBuilder.Entity("GameOn.Domain.LoLGame", b =>
                {
                    ...
                    b.Property<int?>("AceParticipantId")
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("MvpParticipantId")
                        .HasColumnType("int")
                    ...
                    b.HasIndex("AceParticipantId");

                    b.HasIndex("MvpParticipantId");
            ...
            modelBuilder.Entity("GameOn.Domain.LoLGameCoachReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("LeagueOfLegendsGameCoachReport", (string)null);
                });
            ...
            modelBuilder.Entity("GameOn.Domain.LoLGameParticipantRankChange", b =>
                {
                    b.Property<int>("LoLGameParticipantId")
                        .HasColumnType("int")
                        .HasColumnName("lol_game_participant_id");
                    ...
                    b.Property<int>("LeaguePointsAfter")
                        .HasColumnType("int")
                        .HasColumnName("league_points_after");

                    b.Property<int>("LeaguePointsBefore")
                        .HasColumnType("int")
                        .HasColumnName("league_points_before");

                    b.Property<int>("LeaguePointsChange")
                        .HasColumnType("int")
                        .HasColumnName("league_points_change");

                    b.Property<string>("RankAfter")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
                        .HasColumnName("rank_after");

                    b.Property<string>("RankBefore")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
                    ...
                    b.ToTable("LeagueOfLegendsGameParticipantRankChange", (string)null);
                });
            ...
            modelBuilder.Entity("GameOn.Domain.LoLGameParticipantStat", b =>
                {
                    ...
                    b.Property<int>("TimeCcOthersSeconds")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GameOn.Domain.LoLGameTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("LeagueOfLegendsGameTeam", (string)null);
                });
            ...
            modelBuilder.Entity("GameOn.Domain.LoLGame", b =>
                {
                    b.HasOne("GameOn.Domain.LoLGameParticipant", null)
                        .WithMany()
                        .HasForeignKey("AceParticipantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("FK_LoLGame_Ace_Participant");

                    b.HasOne("GameOn.Domain.LoLGameParticipant", null)
                        .WithMany()
                        .HasForeignKey("MvpParticipantId")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("GameOn.Domain.LoLGameParticipantRankChange", b =>
                {
                    b.HasOne("GameOn.Domain.LoLGameParticipant", "Participant")
                        .WithOne("RankChange")
                        .HasForeignKey("GameOn.Domain.LoLGameParticipantRankChange", "LoLGameParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("GameOn.Domain.LoLGameTeam", b =>
                {
                    b.HasOne("GameOn.Domain.LoLGame", "Game")
                        .WithMany("LeagueOfLegendsGameTeams")
                        .HasForeignKey("MatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("GameOn.Domain.Player", b =>
                {
                    b.HasOne("GameOn.Domain.Player", "PrimaryPlayer")
                        .WithMany("SmurfAccounts")
            ...
            modelBuilder.Entity("GameOn.Domain.LoLGame", b =>
                {
                    ...
                    b.Navigation("LeagueOfLegendsGameTeams");
