...
{
    /// <inheritdoc />
    public partial class First_Migration_MySQL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    keycloak_id = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    profile_picture_url = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    created_on = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2024, 8, 6, 9, 21, 58, 290, DateTimeKind.Utc).AddTicks(3899))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    phase2_challonge_url = table.Column<string>(type: "varchar(3000)", maxLength: 3000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    planned_from = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2024, 8, 6, 9, 21, 58, 290, DateTimeKind.Utc).AddTicks(4888)),
                    planned_to = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2024, 8, 7, 9, 21, 58, 290, DateTimeKind.Utc).AddTicks(5106))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    played_on = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2024, 8, 6, 11, 21, 58, 290, DateTimeKind.Local).AddTicks(9680)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    joined_at = table.Column<DateTime>(type: "datetime(6)", nullable: false, defaultValue: new DateTime(2024, 8, 6, 9, 21, 58, 290, DateTimeKind.Utc).AddTicks(5755))
                },
                constraints: table =>
                {
