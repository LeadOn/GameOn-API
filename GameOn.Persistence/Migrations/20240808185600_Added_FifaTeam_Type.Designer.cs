...
namespace GameOn.Persistence.Migrations
{
    ...
    [Migration("20240808185600_Added_FifaTeam_Type")]
    partial class Added_FifaTeam_Type
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameOn.Domain.FifaGamePlayed", b =>
                {
                    ...
                    b.Property<DateTime>("PlayedOn")
                        ...
                        .HasDefaultValue(new DateTime(2024, 8, 8, 20, 56, 0, 11, DateTimeKind.Local).AddTicks(5080))
            ...
            modelBuilder.Entity("GameOn.Domain.Player", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 18, 56, 0, 10, DateTimeKind.Utc).AddTicks(8209))
            ...
            modelBuilder.Entity("GameOn.Domain.Tournament", b =>
                {
                    ...
                    b.Property<DateTime>("PlannedFrom")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 18, 56, 0, 10, DateTimeKind.Utc).AddTicks(9428))
                        .HasColumnName("planned_from");

                    b.Property<DateTime>("PlannedTo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 9, 18, 56, 0, 10, DateTimeKind.Utc).AddTicks(9622))
            ...
            modelBuilder.Entity("GameOn.Domain.TournamentPlayer", b =>
                {
                    ...
                    b.Property<DateTime>("JoinedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 8, 8, 18, 56, 0, 11, DateTimeKind.Utc).AddTicks(1109))
