...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YuGames.Domain.FifaTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("YuGames.Domain.FifaTeamPlayer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("YuGames.Domain.Highlight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("YuGames.Domain.Platform", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("YuGames.Domain.Player", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("YuGames.Domain.Season", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("YuGames.Domain.Tournament", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("YuGames.Domain.TournamentPlayer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("YuGames.Domain.FifaGamePlayed", b =>
                {
                    b.HasOne("YuGames.Domain.Player", "CreatedBy")
                    ...
                    b.HasOne("YuGames.Domain.Platform", "Platform")
                    ...
                    b.HasOne("YuGames.Domain.Season", "Season")
            ...
            modelBuilder.Entity("YuGames.Domain.FifaTeamPlayer", b =>
                {
                    b.HasOne("YuGames.Domain.FifaGamePlayed", "FifaGamePlayed")
                    ...
                    b.HasOne("YuGames.Domain.Player", "Player")
            ...
            modelBuilder.Entity("YuGames.Domain.Highlight", b =>
                {
                    ...
                    b.HasOne("YuGames.Domain.FifaGamePlayed", "FifaGame")
                        .WithMany("Highlights")
                        .HasForeignKey("FifaGameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("YuGames.Domain.TournamentPlayer", b =>
                {
                    b.HasOne("YuGames.Domain.FifaTeam", "FifaTeam")
