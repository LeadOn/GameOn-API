...
namespace GameOn.Presentation.Controllers.LeagueOfLegends
{
    ...
    public class StatsController : ControllerBase
    {
        ...
        /// <param name="includeSmurfs">If false, smurf accounts are left out of the records entirely. Defaults to true: a smurf holds its own games and wins awards in its own name.</param>
        /// <param name="includeOutOfCrew">If true, accounts outside the crew take part in the records too. Defaults to false: these records describe the crew.</param>
        ...
        public async Task<IActionResult> GetGlobalStats(bool rankedOnly = false, LoLQueueFilter queue = LoLQueueFilter.All, LoLStatsPeriod period = LoLStatsPeriod.AllTime, bool includeSmurfs = true, bool includeOutOfCrew = false)
        {
